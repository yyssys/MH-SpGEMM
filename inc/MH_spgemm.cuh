...
void Calculate_B_tilePtr(CSR &B, Tool &tools)
{
    ...
    {
        k_calculate_B_tilePtr_shared_hash_tb<hash_size_B_tileptr[3]><<<tools.h_bin_size[8], 512, 0, tools.streams[7]>>>(B.d_ptr, B.d_col, B.d_tileptr, tools.d_bins_B + tools.h_bin_offset[8]);
    }
    if (tools.h_bin_size[7])
    {
        k_calculate_B_tilePtr_shared_hash_tb<hash_size_B_tileptr[2]><<<tools.h_bin_size[7], 256, 0, tools.streams[6]>>>(B.d_ptr, B.d_col, B.d_tileptr, tools.d_bins_B + tools.h_bin_offset[7]);
    }
    if (tools.h_bin_size[5])
    {
        k_calculate_B_tilePtr_shared_hash_tb<hash_size_B_tileptr[0]><<<tools.h_bin_size[5], 64, 0, tools.streams[4]>>>(B.d_ptr, B.d_col, B.d_tileptr, tools.d_bins_B + tools.h_bin_offset[5]);
    }
    if (tools.h_bin_size[6])
    {
        k_calculate_B_tilePtr_shared_hash_tb<hash_size_B_tileptr[1]><<<tools.h_bin_size[6], 128, 0, tools.streams[5]>>>(B.d_ptr, B.d_col, B.d_tileptr, tools.d_bins_B + tools.h_bin_offset[6]);
    }
...
void Calculate_B_tileColAndtileMask(CSR &B, Tool &tools)
{
    ...
    if (tools.h_bin_size[4])
    {
        k_calculate_B_tileColAndtileMask_shared_hash_tb<hash_size_B_tileColAndtileMask[0]><<<tools.h_bin_size[4], 64, 0, tools.streams[3]>>>(B.d_ptr, B.d_col, B.d_tileptr, B.d_tilecol, B.d_tilemask, tools.d_bins_B + tools.h_bin_offset[4]);
    }
    if (tools.h_bin_size[5])
    {
        k_calculate_B_tileColAndtileMask_shared_hash_tb<hash_size_B_tileColAndtileMask[1]><<<tools.h_bin_size[5], 128, 0, tools.streams[4]>>>(B.d_ptr, B.d_col, B.d_tileptr, B.d_tilecol, B.d_tilemask, tools.d_bins_B + tools.h_bin_offset[5]);
    }
    if (tools.h_bin_size[6])
    {
        k_calculate_B_tileColAndtileMask_shared_hash_tb<hash_size_B_tileColAndtileMask[2]><<<tools.h_bin_size[6], 256, 0, tools.streams[5]>>>(B.d_ptr, B.d_col, B.d_tileptr, B.d_tilecol, B.d_tilemask, tools.d_bins_B + tools.h_bin_offset[6]);
    }
    if (tools.h_bin_size[7])
    {
        k_calculate_B_tileColAndtileMask_shared_hash_tb<hash_size_B_tileColAndtileMask[3]><<<tools.h_bin_size[7], 512, 0, tools.streams[6]>>>(B.d_ptr, B.d_col, B.d_tileptr, B.d_tilecol, B.d_tilemask, tools.d_bins_B + tools.h_bin_offset[7]);
    }
    if (tools.h_bin_size[8])
    {
    ...
    if (tools.h_bin_size[9])
    {
        k_calculate_B_tileColAndtileMask_global_mem<<<tools.h_bin_size[9], 1024, 0, tools.streams[8]>>>(B.d_ptr, B.d_col, B.d_tileptr, B.d_tilecol, B.d_tilemask, (MASK_TYPE *)tools.d_global_mem_pool, tools.d_bins_B + tools.h_bin_offset[9], (B.N + BLOCK_SIZE - 1) / BLOCK_SIZE);
    }
}
...
void Calculate_C_nnz_by_OR_CtileMask(const CSR &A, const CSR &B, CSR &C, Tool &tools)
{
    ...
    if (tools.h_bin_size[8])
    {
        k_calculate_C_tileColAndtileMask_global_mem<<<tools.h_bin_size[8], 1024, 0, tools.streams[7]>>>(A.d_ptr, A.d_col, B.d_tileptr, B.d_tilecol, B.d_tilemask, C.d_tileptr, tools.d_bins_C + tools.h_bin_offset[8], C.d_ptr, (C.N + BLOCK_SIZE - 1) / BLOCK_SIZE, tools.d_global_mem_pool, tools.group_size);
    }
}
...
void Form_mask_matrix_B(const CSR &A, CSR &B, CSR &C, Tool &tools)
{
    ...
    {
        printf("Calculate_B_tilePtr global row: %d\n", tools.h_bin_size[10]);
    ...
    {
        printf("Calculate_B_tileColAndtileMask global row: %d\n", tools.h_bin_size[9]);
...
void Calculate_C_nnz(const CSR &A, const CSR &B, CSR &C, Tool &tools)
{
    ...
    {
        printf("Calculate_C_tilePtr global row: %d\n", tools.h_bin_size[8]);
    ...
    // printf("C mask count: %d\n", *tools.count);

    CHECK_ERROR(cudaMemset(C.d_ptr, 0, (C.M + 1) * sizeof(int)));
    if (tools.h_bin_size[8] != 0)
    {
        printf("symbolic step global row:%d\n", tools.h_bin_size[8]);
...
void h_numeric(const CSR &A, const CSR &B, CSR &C, Tool &tools)
{
    ...
    if (tools.h_bin_size[8])
    {
        ...
        printf("numeric step global row:%d\n", tools.h_bin_size[8]);
